...
import com.danielara.ForoHub.models.topic.validaciones.ValidadorCancelamientoDeTopic;
import com.danielara.ForoHub.models.topic.validaciones.ValidadorTopic;
...
public class TopicService {
    ...
    public Course getValidCourse(@NotBlank String courseName) {
        return courseRepository.findByName(courseName)
                .orElseThrow(() -> new ValidationException("Curso no existe"));
    }
    @Transactional
    public TopicDetailsDTO register(TopicFormDTO datos) {
